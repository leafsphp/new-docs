...
This section assumes you've read [working with controllers](leaf/v/2.1-apha/routing/controller). In an MVC application, controllers play a major role as they're the bridge between your view and your model.
...
Resource routes are handled by a [resource controller](leaf/v/2.1-apha/routing/controller?id=resource-controller).
