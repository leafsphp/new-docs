...
Using the core controller, you already have access to templating with [Leaf Veins](leaf/v/lucky-charm/views/veins). You can simply configure and render your template whenever you want to.
...
You can view more info on Veins [here](leaf/v/lucky-charm/views/veins)
...
You can view more on responses [here](leaf/v/lucky-charm/http/response)
...
Read more on Leaf Forms [here](leaf/v/lucky-charm/core/forms)
