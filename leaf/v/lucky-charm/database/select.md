...
`choose` also has inbuilt validation which validates parameters according to set rules. This uses the [`Leaf\Form->validate`](leaf/v/lucky-charm/core/form) method. You can check it out for more information on validation.
