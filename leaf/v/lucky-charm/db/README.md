...
Validate takes in 2 parameters, a field to validate and a validation rule. You can find all the validation rules and what they do [here](leaf/v/lucky-charm/core/forms?id=multiple-rule-validation). So what if you need to validate more than 1 parameter?
...
[Auth](leaf/v/lucky-charm/core/auth)
[Response](leaf/v/lucky-charm/http/response)
[Request](leaf/v/lucky-charm/http/request)
[Session](leaf/v/lucky-charm/http/session)
