...
`add` also has inbuilt validation which validates parameters according to set rules. This uses the [`Leaf\Form->validate`](leaf/v/2.4/core/form) method. You can check it out for more information on validation.
