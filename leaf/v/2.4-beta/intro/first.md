...
First of all, we need to setup our .htaccess file. See [configuring .htaccess](leaf/v/2.4-beta/intro/htaccess)
...
You might have seen it above, but you can use [response](leaf/v/2.4-beta/http/response) on `$app`, you can also do the same with [request](leaf/v/2.4-beta/http/request). Basically, response let's you deal with output, while request deals with input into your app.
...
Leaf Db provides a ton of features ready for use anywhere in your app. [Read the docs here](leaf/v/2.4-beta/db/)
...
[Auth](leaf/v/2.4-beta/core/auth) is a module created to make authentication as simple as 1 line of code. Yes, 1 line😆
...
- [Leaf Config](leaf/v/2.4-beta/config/)
