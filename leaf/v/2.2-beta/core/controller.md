...
Using the core controller, you already have access to templating with [Leaf Veins](leaf/v/2.2-beta/views/veins). You can simply configure and render your template whenever you want to.
...
You can view more info on Veins [here](leaf/v/2.2-beta/views/veins)
...
You can view more on responses [here](leaf/v/2.2-beta/http/response)
...
Read more on Leaf Forms [here](leaf/v/2.2-beta/core/forms)
