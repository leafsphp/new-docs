...
Validate takes in 2 parameters, a field to validate and a validation rule. You can find all the validation rules and what they do [here](leaf/v/2.1/core/forms?id=multiple-rule-validation). So what if you need to validate more than 1 parameter?
...
[Auth](leaf/v/2.1/core/auth)
[Response](leaf/v/2.1/http/response)
[Request](leaf/v/2.1/http/request)
[Session](leaf/v/2.1/http/session)
