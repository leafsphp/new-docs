...
Using the core controller, you already have access to templating with [Leaf Veins](leaf/v/2.5.0-beta/views/veins). You can simply configure and render your template whenever you want to.
...
You can view more info on Veins [here](leaf/v/2.5.0-beta/views/veins)
