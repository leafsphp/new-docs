...
Validate takes in 2 parameters, a field to validate and a validation rule. You can find all the validation rules and what they do [here](v/2.2-beta/core/forms?id=multiple-rule-validation). So what if you need to validate more than 1 parameter?
...
[Auth](v/2.2-beta/core/auth)
[Response](v/2.2-beta/http/response)
[Request](v/2.2-beta/http/request)
[Session](v/2.2-beta/http/session)
