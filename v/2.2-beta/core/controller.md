...
Using the core controller, you already have access to templating with [Leaf Veins](v/2.2-beta/views/veins). You can simply configure and render your template whenever you want to.
...
You can view more info on Veins [here](v/2.2-beta/views/veins)
...
You can view more on responses [here](v/2.2-beta/http/response)
...
Read more on Leaf Forms [here](v/2.2-beta/core/forms)
